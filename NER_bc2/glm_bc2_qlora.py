...
# 保存模型参数
torch.save(model.state_dict(), "/data/aim_nuist/aim_zhujj/xinjian/glm_bc2_qloramodel.pt")
...
lora_model.load_state_dict(torch.load("/data/aim_nuist/aim_zhujj/xinjian/glm_bc2_qloramodel.pt"))
...
# 预测标签并输出到output.txt
with open("glm_bc2_qlora.txt", "w") as output_file:

...
base_model = AutoModelForCausalLM.from_pretrained("/data/aim_nuist/aim_zhujj/llama3",torch_dtype=torch.float32, load_in_8bit=True, device_map="sequential",
...
# 保存模型参数
torch.save(model.state_dict(), "/data/aim_nuist/aim_zhujj/xinjian/llama3_bc2_qloramodel.pt")
...
lora_model.load_state_dict(torch.load("/data/aim_nuist/aim_zhujj/xinjian/llama3_bc2_qloramodel.pt"))
...
# 预测标签并输出到output.txt
with open("llama3_bc2_qlora.txt", "w") as output_file:

...
prompt = """
please select labels from the following range according to the text : O,B-Chemical,I-Chemical
"""
...
if __name__ == '__main__':
    ...
    lora_path = '/data/aim_nuist/aim_zhujj/xinjian/glm4_lora_ptuning/GLM4_pt_b5d'
    ...
    for test in test_list:
        try:
            ...
            with torch.no_grad():
                ...
                # 将结果写入文件 output.txt
                with open('glm_b5d_pt_res.txt', 'a', encoding='utf-8') as f:
                    print(result)
                    f.write(result)

...
if __name__ == '__main__':
    ...
    # 加载模型
    model = AutoModelForCausalLM.from_pretrained(mode_path, device_map="auto", torch_dtype=torch.float32, trust_remote_code=True).eval()
    # model = model.half()
    # 加载lora权重
    ...
    for val in val_list:
        ...
        gen_kwargs = {"max_length": 2500, "top_k": 1, "do_sample": True}
        with torch.no_grad():

...
def process_val_dataset():
    dataset = []
    ds = load_dataset("bigbio/blurb", "jnlpba")
    for i in range(len(ds['test'])):
        ...
        with open('./testj_result.json', "w", encoding="utf-8") as file:
...
if __name__ == '__main__':
    ...
    lora_path = '/data/aim_nuist/aim_zhujj/llama3/l3_qlora_j'

    with open("testj_result.json", "r") as f:
    ...
    for val in val_list:
        ...
        with torch.no_grad():
            ...
            with open('l3_ql_j_result.txt', 'a', encoding='utf-8') as f:
                f.write(f"{out}\n")

...
tokenizer = AutoTokenizer.from_pretrained("/share/home/aim/aim_zhujj/PubMedBERT")
model=AutoModelForMaskedLM.from_pretrained("/share/home/aim/aim_zhujj/PubMedBERT").to('cuda')
...
# 保存模型参数
torch.save(model.state_dict(), "pub_model.pt")

# 导入模型参数
model=AutoModelForMaskedLM.from_pretrained("/share/home/aim/aim_zhujj/PubMedBERT").to('cuda')
model.load_state_dict(torch.load("pub_model.pt"))
...
# Predict labels and write to output.txt
with open("pub.txt", "w") as output_file:

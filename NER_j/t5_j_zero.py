...
prompt ='''Select a biological tag from the following range for the text, and give O for any tags that do not belong to this range:O,B-GENE,I-GENE
'''
    ...
    for test in test_list:
        try:
            ...
            with torch.no_grad():
                ...
                # 将结果写入文件 output.txt
                with open('t5_j_zero_res.txt', 'a', encoding='utf-8') as f:
                    print(result)
                    f.write(result)

...
def load_and_process_data(text_folder, label_folder):
    data = []
    skipped_files = 0
    ...
    for text_file in text_files:
        ...
        data.append({"input": text_content, "output": label_content})
...
if __name__ == '__main__':
    ...
    df = load_and_process_data(text_folder, label_folder)
    ds = Dataset.from_pandas(df)

    glm4_model_path = '/data/aim_nuist/aim_zhujj/xinjian/glm4_lora_ptuning/ZhipuAI/glm-4-9b-chat'
    lora_path = '/data/aim_nuist/aim_zhujj/xinjian/glm4_lora_ptuning/GLM4_pt_hoc'

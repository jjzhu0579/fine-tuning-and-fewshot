...
prompt = '''Please understand whether the two sentences are similar or different'''
...
if __name__ == '__main__':
    ...
    lora_path = '/data/aim_nuist/aim_zhujj/xinjian/glm_st_pt'
    ...
    for test in test_list:
        try:
            ...
            with torch.no_grad():
                ...
                # 将结果写入文件 output.txt
                with open('glm_st_pt_res.txt', 'a', encoding='utf-8') as f:
                    print(result)
                    f.write(result)

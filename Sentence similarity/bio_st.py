...
# 保存模型参数
torch.save(model.state_dict(), "/data/aim_nuist/aim_zhujj/bio_st_model.pt")
...
model.load_state_dict(torch.load("/data/aim_nuist/aim_zhujj/bio_st_model.pt"))
...
# 预测标签并输出到output.txt
with open("bio_st_result.txt", "w") as output_file:

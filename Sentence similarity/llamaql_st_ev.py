...
prompt = '''Please understand whether the two sentences are similar or different,just answer me sililar or different'''
...
if __name__ == '__main__':
    ...
    lora_path = '/data/aim_nuist/aim_zhujj/llama3/llama_qlora_st'
    ...
    for test in test_list:
        try:
            ...
            with open('la_ql_st.txt', 'a', encoding='utf-8') as f:
                print(result)
                f.write(result)

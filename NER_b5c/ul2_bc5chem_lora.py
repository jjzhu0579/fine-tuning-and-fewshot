...
# 保存模型参数
torch.save(model.state_dict(), "ul2_lora_bc5chem.pt")

# 导入LoRA模型参数
base_model = T5ForConditionalGeneration.from_pretrained("/data/aim_nuist/aim_zhujj/xinjian/ul2")
lora_model = get_peft_model(base_model, lora_config)
lora_model.load_state_dict(torch.load("ul2_lora_bc5chem.pt"))
...
# 预测标签并输出到output.txt
with open("ul2_lora_bc5chem.txt", "w") as output_file:

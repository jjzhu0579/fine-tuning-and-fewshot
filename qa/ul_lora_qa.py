...
base_model = T5ForConditionalGeneration.from_pretrained("/share/home/aim/aim_zhujj/ul2")
# 配置和加载LoRA模型
...
lora_model.load_state_dict(torch.load("ul_lora_model.pt"))
...
with open("lora_ul_qa.txt", "w", encoding='utf-8') as output_file:
...
# 输出JSON格式
with open("lora_ul_qa.json", "w", encoding='utf-8') as json_file:
